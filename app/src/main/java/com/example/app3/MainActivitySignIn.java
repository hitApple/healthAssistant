...
public class MainActivitySignIn extends AppCompatActivity {
    ...
    private void initData() {
        ...
        listX.add("1");
        listX.add("1");
        LinearLayoutManager manager = new LinearLayoutManager(MainActivitySignIn.this);
        manager.setOrientation(LinearLayoutManager.HORIZONTAL);
        rcList.setLayoutManager(manager);
        SignAwardListAdapter adapter = new SignAwardListAdapter(listX, MainActivitySignIn.this);
    ...
    private void initEvent() {
        ...
        rlSignK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rcDate.initRecordList(list);
                Toast.makeText(MainActivitySignIn.this, "点击签到 " , Toast.LENGTH_SHORT).show();
            }
        });
    }
